// O Mod 10 é um algoritmo para validação de cartões que é utilizado pela maioria das
// bandeiras em todo o mundo. A seguir mostro como utilizar o algoritmo para validar
// a numeração do cartão.
// Para validar o cartão de crédito siga esses passos:
// 1. Separe o último dígito do cartão. Neste caso é o zero.

// 2. Multiplique a numeração do cartão, número por número sendo a coluna ímpar
// por 1 e a coluna par por 2, levando em conta que a primeira coluna inicia-se
// por 0 (zero). Se o valor da multiplicação tiver dois dígitos, separe e some
//cada unidade.  Em seguida, some todos os valores.
